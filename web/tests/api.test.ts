...
describe('api plugin', () => {
  ...
  it('plugin injects Accept-Language and Accept-Currency headers via onRequest hook', async () => {
    ...
    let capturedOnRequest: ((ctx: { options: { headers?: Record<string, string> } }) => void) | undefined

    const createMock = vi.fn((opts: { onRequest?: (ctx: { options: { headers?: Record<string, string> } }) => void }) => {
