    ...
    <div class="site-header__inner">
      ...
      <nav class="site-header__nav">
        ...
        <NuxtLink to="/cart" class="site-header__cart">
          Cart
          <span v-if="itemCount > 0" class="site-header__cart-count">{{ itemCount }}</span>
      ...
      <div class="site-header__locale">
        <select
          ...
          :value="language"
          aria-label="Language"
          @change="setLanguage(($event.target as HTMLSelectElement).value as 'en' | 'fr' | 'es')"
        >
        ...
        <select
          ...
          :value="currency"
          aria-label="Currency"
          @change="setCurrency(($event.target as HTMLSelectElement).value as 'USD' | 'EUR' | 'GBP')"
        >
...
const { language, currency, availableLanguages, availableCurrencies, setLanguage, setCurrency } = useLocalization()
</script>
