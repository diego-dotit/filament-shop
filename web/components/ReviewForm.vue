<template>
  ...
  <div v-if="isAuthenticated && alreadyReviewed" class="review-form__already-reviewed" data-testid="already-reviewed">
    <p>You have already submitted a review for this product.</p>
  </div>

  <!-- Success state: show confirmation, hide form -->
  <div v-else-if="submitted" class="review-form__success" role="alert" data-testid="review-success">
  ...
  >
    ...
    <div class="review-form__rating" role="group" aria-label="Rating">
      <label class="review-form__label">Rating <span class="review-form__required">*</span></label>
    ...
    <div class="review-form__comment-group">
      ...
      />
      <p class="review-form__char-count" :class="{ 'review-form__char-count--over': commentTooLong }">
        {{ comment.length }} / 500
      </p>
