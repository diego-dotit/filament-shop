<template>
  <div class="category-page">
    ...
    <div v-if="notFound" class="category-page__error">
      <p>Category not found. Please check the URL or go back to the <NuxtLink to="/">homepage</NuxtLink>.</p>
    </div>
...
const products = ref<Array<{ id: number; name: string; slug: string; price: string; images: string[] }>>([])
