      ...
      <div class="order-addresses">
        <section class="billing-address">
          ...
          <address>
            ...
            <div>{{ currentOrder.billing_address.city }}, {{ currentOrder.billing_address.country }}</div>
          </address>
        </section>
        ...
        <section class="shipping-address">
          ...
          <address>
            ...
            <div>{{ currentOrder.shipping_address.city }}, {{ currentOrder.shipping_address.country }}</div>
          </address>
        </section>
      </div>
    </div>
